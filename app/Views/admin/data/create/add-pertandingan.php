        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              ...
              <?php endif; ?>
              <form class="p-md-4" action="<?= base_url('admin/data/create/savepertandingan') ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select name="kd_team2" class="form-control <?= $validation->hasError('kd_team2') ? 'is-invalid' : null ?>" id="">
                        <option disabled selected>-- Team 2 --</option>
                        <?php foreach ($teams as $team) : ?>
                          <option value="<?= $team->kd_team ?>"><?= $team->nama_team ?></option>
                        <?php endforeach; ?>
                      </select>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select name="kd_stadion" class="form-control <?= $validation->hasError('kd_stadion') ? 'is-invalid' : null ?>" id="">
                        <option disabled selected>-- Stadion --</option>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="date" name="tanggal" class="form-control <?= $validation->hasError('tanggal') ? 'is-invalid' : null ?>" value="" min="2022-01-01" max="2099-12-31">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="team1">Jam Pertandingan</label>
                      <input type="time" name="waktu" class="form-control <?= $validation->hasError('waktu') ? 'is-invalid' : null ?>" id="">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="number" name="harga_tb_timur" class="form-control <?= $validation->hasError('harga_tb_timur') ? 'is-invalid' : null ?>" id="">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <span class="input-group-text">Rp.</span>
                        <input type="number" name="harga_tb_vvip" class="form-control <?= $validation->hasError('harga_tb_vvip') ? 'is-invalid' : null ?>" id="">
                      </div>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <span class="input-group-text">Rp.</span>
                        <input type="number" name="harga_tb_barat" class="form-control <?= $validation->hasError('harga_tb_barat') ? 'is-invalid' : null ?>" id="">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    ...
                    ">
                      ...
                      <div class="input-group">
                        <span class="input-group-text">Rp.</span>
                        <input type="number" name="harga_tb_vip" class="form-control <?= $validation->hasError('harga_tb_vip') ? 'is-invalid' : null ?>" id="">
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select name="status" class="form-control <?= $validation->hasError('status') ? 'is-invalid' : null ?>" id="">
                        <option disabled selected>-- Status Pertandingan --</option>

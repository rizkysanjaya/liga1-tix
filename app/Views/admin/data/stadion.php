        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h4>Stadion table</h4>
              <a href="<?= base_url('/admin/data/create/add-stadion') ?>">
                <button type="button" class="btn bg-gradient-primary">Add Stadion</button>
              </a>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-md-3">
                <table class="table align-items-center mb-0" id="dataTable" style="table-layout:auto">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Stadion Name</th>
                        ...
                        <td>
                          <div class="d-flex px-2 py-1">
                            ...
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm"><?= $stadion->nama_stadion ?></h6>
                              <p class="text-xs text-secondary mb-0"><?= $stadion->kd_stadion ?></p>
                            </div>
                          </div>
                        </td>
                        <td>

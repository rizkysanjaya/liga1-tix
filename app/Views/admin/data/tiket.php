            ...
            <div class="card-body px-0 pt-0 pb-2">
              ...
              <div class="table-responsive p-md-3">
                <table class="table align-items-center mb-0" id="dataTable" style="table-layout:auto">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Kode Tiket & Order</th>
                        ...
                        <td>
                          <div class="d-flex px-2 py-1">
                            ...
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm"><?= $k['kd_tiket']; ?></h6>

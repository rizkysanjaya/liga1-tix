        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h4>Team table</h4>
              <a href="<?= base_url('/admin/data/create/add-team') ?>">
                <button type="button" class="btn bg-gradient-primary">Add Team</button>
              </a>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div>
                              <img src="<?= base_url(); ?>/assets/img/team_logo/<?= $team->logo ?>" class="avatar avatar-sm me-3" alt="team1">
                            </div>
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm"><?= $team->nama_team ?></h6>
                              <p class="text-xs text-secondary mb-0"><?= $team->kd_team ?></p>
                            </div>
                          </div>
                        </td>
                        <td>

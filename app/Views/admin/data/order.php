            ...
            <div class="card-body px-0 pt-0 pb-2">
              ...
              <div class="table-responsive p-md-3">
                <table class="table align-items-center mb-0" id="dataTable" style="table-layout:auto">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">KD Order & Match</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Email Pembeli</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tanggal Order</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Qty Tiket</th>
                    ...
                    <?php foreach ($order as $k) : ?>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex px-2 py-1">
                            ...
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm"><?= $k['kd_order']; ?></h6>
                              <p class="text-xs text-secondary mb-0"><?= $k['kd_pertandingan']; ?></p>
                            </div>
                          </div>
                        </td>
                        <td>
                        ...
                        <td class="align-middle text-sm">
                          <p class="text-xs font-weight-bold mb-0"><?= $k['tgl_order']; ?></p>
                        </td>
                        <td class="align-middle text-sm">
                          <p class="text-xs font-weight-bold mb-0"><?= $k['jml_tiket']; ?></p>
                        </td>
                        <td class="align-middle text-sm">
                          <?php if ($k['status'] == '1') { ?>
